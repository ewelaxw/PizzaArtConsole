...
const Summary = (props) => {
    ...
    return (react_1.default.createElement(ink_1.Box, { flexDirection: "column" },
        react_1.default.createElement(ink_1.Text, null, `Pizza:${orderSummary.name} Size:${orderSummary.size} Price:${orderSummary.price} zł`),
        ...
        react_1.default.createElement(ink_1.Text, null, `Price: ${getSummary()} zł`),
        react_1.default.createElement(ink_1.Newline, null),
